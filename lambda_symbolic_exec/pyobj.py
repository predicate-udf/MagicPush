...
class Frame(object):
    def __init__(self, f_code, f_globals, f_locals, f_back):
        ...
        #print("co_cellvars = {}, freevars = {}".format(f_code.co_cellvars, f_code.co_freevars))
        for var in f_code.co_cellvars:
            # Make a cell for the variable in our locals, or None.
            #self.cells[var] = Cell(self.f_locals.get(var))
            self.cells.append(Cell(self.f_locals.get(var)))
    ...
    def fork(self):
        n = Frame(self.f_code, self.f_globals, self.f_locals, self.f_back)
        n.f_lineno = self.f_lineno 
        n.f_lasti = self.f_lasti
        n.stack = [x for x in self.stack]
        n.block_stack = [x for x in self.block_stack]
        return n
