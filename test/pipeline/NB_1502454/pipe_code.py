import pickle
import pandas as pd
df0 = pickle.load(open("data_187.pickle",'rb'))
...
df4 = pickle.load(open("data_403.pickle",'rb'))
...
df7 = pickle.load(open("data_514.pickle",'rb'))
...
df10 = pickle.load(open("data_626.pickle",'rb'))
...
df13 = pickle.load(open("data_405.pickle",'rb'))
...
df16 = pickle.load(open("data_849.pickle",'rb'))
...
df21 = pickle.load(open("data_1072.pickle",'rb'))
...
df24 = pickle.load(open("data_1184.pickle",'rb'))
...
df29 = pickle.load(open("data_1407.pickle",'rb'))
...
df33 = pickle.load(open("data_1416.pickle",'rb'))
...
df39 = df38.dropna(subset=["date","marketcap(USD)","US.LE_IX","US.PCPI_IX","US.ENDE_XDC_USD_RATE","KR.LE_IX","KR.PCPI_IX","KR.ENDE_XDC_USD_RATE","JP.LE_IX","JP.PCPI_IX","JP.ENDE_XDC_USD_RATE","RU.LE_IX","RU.PCPI_IX","RU.ENDE_XDC_USD_RATE"])
df40 = df39[df39.apply(lambda row: (row['date'] >= pd.to_datetime('2016-01-01 00:00:00')) and (row['date'] < pd.to_datetime('2016-06-01 00:00:00')), axis=1)]
pickle.dump(df40, open('./temp/result_original.p', 'wb'))